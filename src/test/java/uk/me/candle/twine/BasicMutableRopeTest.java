...
public class BasicMutableRopeTest {
    ...
    public void itCanIterateOverASimpleRope() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcd"));
    ...
    public void itCanConcaternateTwoRopes() throws Exception {
        Rope<CharSeqSliceable> first = new BasicMutableRope<>(new CharSeqSliceable("abcd"));
        Rope<CharSeqSliceable> second = new BasicMutableRope<>(new CharSeqSliceable("efgh"));
        Rope<CharSeqSliceable> result = first.append(second);
    ...
    public void itCanCreateFromMultipleElements() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcd"), new CharSeqSliceable("efgh"));
    ...
    public void itCanSplitOnSliceableBoundaries() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcd"), new CharSeqSliceable("efgh"));
        List<Rope<CharSeqSliceable>> results = undertest.split(4);
    ...
    public void itCanSplitInTheMiddleOfASliceable() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcd"), new CharSeqSliceable("efgh"), new CharSeqSliceable("ijkl"));
        ((BasicMutableRope)undertest).printTree(System.out);
        List<Rope<CharSeqSliceable>> results = undertest.split(6);
    ...
    public void itCanSplitToAZeroLengthRope() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcd"), new CharSeqSliceable("efgh"), new CharSeqSliceable("ijkl"));
        List<Rope<CharSeqSliceable>> results = undertest.split(0);
    ...
    public void itCanInsertSliceableOnSliceableBoundaries() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcd"), new CharSeqSliceable("ijkl"));
        CharSeqSliceable toInsert = new CharSeqSliceable("efgh");
        Rope<CharSeqSliceable> result = undertest.insert(4, toInsert);
    ...
    public void itCanInsertRopeOnSliceableBoundaries() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcd"), new CharSeqSliceable("ijkl"));
        Rope<CharSeqSliceable> toInsert = new BasicMutableRope<>(new CharSeqSliceable("efgh"));
        Rope<CharSeqSliceable> result = undertest.insert(4, toInsert);
        assertThat(ropeToString(result), is("abcdefghijkl"));
    }
    ...
    public void itCanInsertSliceableOnAnyBoundary() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcdijkl"));
        CharSeqSliceable toInsert = new CharSeqSliceable("efgh");
        Rope<CharSeqSliceable> result = undertest.insert(4, toInsert);
        assertThat(ropeToString(result), is("abcdefghijkl"));
    }
    ...
    public void itCanDeleteAWholeElement() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcd"), new CharSeqSliceable("efgh"), new CharSeqSliceable("ijkl"));
        Rope<CharSeqSliceable> result = undertest.delete(4, 4); // should remove "efgh"
    ...
    public void itCanDeleteFromTheStartOfAnElement() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcd"), new CharSeqSliceable("efgh"), new CharSeqSliceable("ijkl"));
        Rope<CharSeqSliceable> result = undertest.delete(4, 2); // should remove "ef"
    ...
    public void itCanDeleteFromTheEndOfAnElement() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcd"), new CharSeqSliceable("efgh"), new CharSeqSliceable("ijkl"));
        Rope<CharSeqSliceable> result = undertest.delete(6, 2); // should remove "gh"
    ...
    public void itCanDeleteFromTheMiddleOfAnElement() throws Exception {
        Rope<CharSeqSliceable> undertest = new BasicMutableRope<>(new CharSeqSliceable("abcd"), new CharSeqSliceable("efgh"), new CharSeqSliceable("ijkl"));
        Rope<CharSeqSliceable> result = undertest.delete(5, 2); // should remove "fg"
    ...
    private String ropeToString(Rope<CharSeqSliceable> undertest) {
